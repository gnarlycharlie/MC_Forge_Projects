...
public class ataGenerator implements IWorldGenerator{
	...
	private void generateSurface(World world, Random random, int i, int j) {
		for(int k = 0; k < 4; k++) {
			...
			int garnetBlockYCoord = random.nextInt(40);
		...
		for(int l = 0; l < 4; l++) {
			...
			int malachiteBlockYCoord = random.nextInt(40);
		...
		for(int m = 0; m < 4; m++) {
			...
			int sodaliteBlockYCoord = random.nextInt(40);
